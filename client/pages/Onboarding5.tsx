...
export default function Onboarding5() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col px-[25px] pt-[25px] pb-0">
      {/* Content */}
      <div className="flex-1 flex flex-row justify-center items-center">
        <div className="w-full max-w-[343px] flex flex-col items-center gap-[60px]">
          {/* Title */}
          ...
          <div className="flex justify-center w-full">
            <img
              ...
              className="aspect-[1] object-contain w-[200px] h-[200px]"
            />
          </div>
        </div>
      </div>
